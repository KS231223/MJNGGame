    ...
    <div className="mj">
      ...
      <div className="mj__seat mj__seat--top">
        <SeatView
          player={seats?.top}
          handNode={
            <HiddenHand count={seats?.top?.tileCount ?? 13} variant="back" />
          }
      ...
      <div className="mj__seat mj__seat--left">
        <SeatView
          player={seats?.left}
          handNode={
            <HiddenHand count={seats?.left?.tileCount ?? 13} variant="side" />
          }
      ...
      <div className="mj__seat mj__seat--right">
        <SeatView
          player={seats?.right}
          handNode={
            <HiddenHand count={seats?.right?.tileCount ?? 13} variant="side" />
          }
